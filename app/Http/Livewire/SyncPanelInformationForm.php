...
class SyncPanelInformationForm extends Component
{
     ...
     * @var bool
     */
    public bool $displayPanelCreationForm = false;
     ...
     * @return void
     */
    public function checkingForPanelExistence(array $payload = null)
    {
        $this->state = $payload;
        $this->state['site_id'] = $this->model->site->id;
        ...
        try {
            $panel = Panel::query()
                ->where([
                    ...
                    'panel_zone' => $this->state['panel_zone'],
                    'panel_sub_zone' => $this->state['panel_sub_zone'],
                    'panel_string' => $this->state['panel_string'],
                ])
                ->get();
            ...
            $this->emit('panelExist', $this->displayPanelCreationForm);
