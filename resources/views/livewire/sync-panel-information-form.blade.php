<div x-data x-show='$wire.displayPanelCreationForm' class="px-4 py-2 sm:px-6">
  <div class="max-w-md p-4 mb-4 text-white bg-blue-500 rounded-md shadow">
    ...
    <div>
      ...
      {{ __('This is necessary to keep a historical tracking on the selected asset.') }}
    </div>
  </div>
  <form wire:submit.prevent='store' id="panel-sync-form" class="my-2">
    ...
    <div class="inline-flex items-center justify-between w-full mt-3">
      <x-jet-button>
        <i class="mr-2 fa-solid fa-rotate fa-fw"></i> {{ __('Sync panel information') }}
      </x-jet-button>
