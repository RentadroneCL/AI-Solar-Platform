<div>
  <div class="flex flex-col mx-4 mb-5 md:flex-row md:mx-0">
    <x-jet-button class="w-full mb-4 md:w-auto md:mb-0" wire:click="$toggle('displayEquipmentTypeCreationForm')">
      <i class="mr-2 text-blue-300 dark:text-white fa-solid fa-circle-plus fa-fw"></i> {{ __('Create new type') }}
    </x-jet-button>

    <x-jet-secondary-button class="w-full mb-4 md:ml-auto md:mb-0 md:w-auto" wire:click="$toggle('showImportModal')">
