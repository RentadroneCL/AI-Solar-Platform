            ...
            <x-jet-form-section submit="addTeamMember">
                ...
                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600 dark:text-slate-500">
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            ...
                            <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer dark:border-slate-600">
                                @foreach ($this->roles as $index => $role)
                                    <button type="button" class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue {{ $index > 0 ? 'border-t border-gray-200 dark:border-slate-600 rounded-t-none' : '' }} {{ ! $loop->last ? 'rounded-b-none' : '' }}"
                                        ...
                                        <div class="{{ isset($addTeamMemberForm['role']) && $addTeamMemberForm['role'] !== $role->key ? 'opacity-50' : '' }}">
                                            ...
                                            <!-- Role Description -->
                                            <div class="mt-2 text-xs text-gray-600 dark:text-slate-500">
                                                {{ $role->description }}
                                            </div>
                                        </div>
                                    </button>
                    ...
                    <div class="space-y-6">
                        @foreach ($team->teamInvitations as $invitation)
                            <div class="flex items-center justify-between">
                                <div class="text-gray-600 dark:text-slate-500">{{ $invitation->email }}</div>
