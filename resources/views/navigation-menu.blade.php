<nav x-data="{ open: false }" class="fixed top-0 z-50 w-full bg-white border-b border-gray-100 opacity-100">
          ...
          <x-jet-dropdown align="right" width="48">
            ...
            <x-slot name="content">
              ...
              <x-jet-dropdown-link href="{{ route('profile.show') }}">
                <i class="mr-2 fa-solid fa-user-large fa-fw text-slate-500"></i> {{ __('Profile') }}
              </x-jet-dropdown-link>
              ...
              <div class="border-t border-gray-100"></div>
                ...
                <form method="POST" action="{{ route('logout') }}">
                  ...
                  <x-jet-dropdown-link href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();">
                    <i class="mr-2 fa-solid fa-door-open fa-fw text-slate-500"></i> {{ __('Logout') }}
                  </x-jet-dropdown-link>
                </form>
            </x-slot>
          </x-jet-dropdown>
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
      ...
      <x-jet-responsive-nav-link href="{{ route('site.index') }}" :active="request()->routeIs('site.index')">
        {{ __('Sites') }}
      </x-jet-responsive-nav-link>
