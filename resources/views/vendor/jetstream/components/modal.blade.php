...
>
    ...
    <div x-show="show" class="mb-6 bg-white dark:bg-slate-800 ring-1 ring-slate-900/5 dark:text-slate-400 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
